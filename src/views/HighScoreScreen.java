...
public class HighScoreScreen extends AAnimationScreen {
	...
	public HighScoreScreen(AAnimationScreenController controller) {
		...
		this.frontPanel.setLayout(new MigLayout("", "[15%][grow][15%]", "[][grow][]"));
		...
		this.frontPanel.add(lblHeader, "cell 1 0, align center"); // expend to fill top.
														// wrap: end of this row
														// in front panel
		JScrollPane scrollPanel = new JScrollPane();
		this.frontPanel.add(createHighScorePanel(), "cell 1 1, grow");
		// this.frontPanel.add(scrollPanel,"grow, wrap");
		this.frontPanel.add(btnMainMenu, "cell 0 2, align left");
	}
	...
	private JTable createHighScoreTable() {
		...
		gameRecordInfo = new Object[13][3];
		/*
		 Object[][] gameRecordInfo = {
		 { "Jay45", "800000", "5/4/13"},
